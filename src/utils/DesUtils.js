...
//now define the left shifts which need to be don
// eslint-disable-next-line
...
// eslint-disable-next-line
  ...
  static desencry(key, message) {
    return this.stringToHex(this.des(key, message, 1, 0, 0, 1));
  }

  static desdecry(key, message) {
    var dec =this.des(key,this.hexToString(message), 0, 0, 0, 0);
